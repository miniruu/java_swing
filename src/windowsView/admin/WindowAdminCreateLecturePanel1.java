...
import module.admin.GoAdminCreateLecture;
import module.admin.GoAdminMenu;
import valueObject.OLecture;

public class WindowAdminCreateLecturePanel1 extends JPanel{
	
	private static final long serialVersionUID = 1L;
	private WindowAdminCreateLecturePanel2 windowAdminCreateLecturePanel2;
	
	public WindowAdminCreateLecturePanel1(WindowAdminMenuPanel windowAdminMenuPanel, JFrame mainFrame){
		...
		windowAdminCreateLecturePanel2 = new WindowAdminCreateLecturePanel2(pathTextFiled, windowAdminMenuPanel);
		mainFrame.add(windowAdminCreateLecturePanel2);
		...
		checkBtn.addActionListener(new GoAdminCreateLecture(this, windowAdminCreateLecturePanel2, pathTextFiled));
		this.add(checkBtn);
