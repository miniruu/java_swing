...
import module.admin.GoAdminDeleteLecture2;
...
public class WindowAdminDeleteLecturePanel1 extends JPanel {
	...
	public WindowAdminDeleteLecturePanel1(WindowAdminMenuPanel windowAdminMenuPanel, JFrame mainFrame){
		...
		this.windowAdminDeleteLecturePanel2 = new WindowAdminDeleteLecturePanel2(pathTextFiled, windowAdminMenuPanel);
		mainFrame.add(windowAdminDeleteLecturePanel2);
		...
		checkBtn.addActionListener(new GoAdminDeleteLecture2(this, windowAdminDeleteLecturePanel2, pathTextFiled, cIndex, cLecture));
		this.add(checkBtn);
